...
public class Simulasi extends javax.swing.JInternalFrame {
 ...
 DecimalFormatSymbols formatRupiah;
    ...
    private void initComponents() {
        ...
        CicilanCbx = new javax.swing.JComboBox<>();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/applicationseducation_103766.png"))); // NOI18N
        jLabel1.setText("Simulasi Cicilan");
        ...
        jLabel2.setText("Silakan Pilih Jenis Mobil di Tabel :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(HargaTxt.getText().isEmpty()){
            ...
            if (CicilanCbx.getSelectedItem()== "24"){
                ...
                int cicilan = 48;
                long lamacicilan = Long.parseLong(Totaltxt.getText()),
                dp = Long.parseLong(DpTxt.getText()),price;
                double totalcicilan, tobay;
                price = lamacicilan - dp;
                totalcicilan = price / cicilan;
                tobay = totalcicilan + dp;
